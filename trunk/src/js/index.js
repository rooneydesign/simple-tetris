...
var KEYBOARD_SPEED = 20; // cells to move per second when key on a keyboard is pressed
var DOWN_KEYBOARD_SPEED = 40; // cells to move per second when down key on a keyboard is  pressed
